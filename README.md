...
GP8XXX series driver libraries for Arduino IDE (currently compatible with GP8101, GP8211S, GP8413, GP8501, GP8503, GP8512, GP8403, GP8302, GP8600, GP8630N) with support for both I2C and I2C1 interfaces
...
## Summary
    This library has already provided sample demos for each of the 11 currently compatible products, and users can use them according to their names. This forked version includes support for both I2C (default) and I2C1 interfaces, allowing for more flexible hardware configurations.
## Installation
